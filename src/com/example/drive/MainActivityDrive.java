...
public class MainActivityDrive extends Activity {
...
Button selectfiles,online,offline;
@Override
...
selectfiles=(Button)findViewById(R.id.bbackgalselectfiles);

offline=(Button)findViewById(R.id.bbackofflngal);
online=(Button)findViewById(R.id.bbackofflngal);
